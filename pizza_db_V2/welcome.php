...
Welcome, to order a pizza click <a href="order.php" />here</a><br /><br />
...
<?php
$db=@mysqli_connect('localhost','root','','pizza_2016')Or die("<p>The database server is not available.</p>");
