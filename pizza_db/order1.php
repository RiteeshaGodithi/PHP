...
// select a database 
@mysqli_select_db($db, "pizza_info") Or die("<p>The database is not available.</p>");
echo "<p>Successfully opened the database.</p>";
// create a query
$SQLstring = "INSERT INTO orders(customer_id,size,type,toppings,price,delivery_option) VALUES('$u', '$size', '$type','$t', '$price','$del')";
// Execute the Query
